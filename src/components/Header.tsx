...
const Header = () => {
  ...
  // Function to toggle chatbot visibility directly
  const toggleChatbot = () => {
    // Set localStorage state to true to open the chatbot
    localStorage.setItem('chatbotOpen', 'true');
    // Dispatch event to notify the chatbot component to open
